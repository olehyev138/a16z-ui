<template>
  <section class="mt-9">
    <h3 class="chartTitle">Overview</h3>
    <div class="row">
      <div class="col-10" style="height: 380px">
      ...
      <div class="col-2 aboutSec">
        ...
        <div>
          ...
          <button class="btn btn--sm my-3">download report</button>
        </div>
      </div>
    </div>
  </section>
...
export default {
  ...
  data() {
    return {
      ...
      series: [
        ...
        {
          name: "Inonovation (Supply)",
          data: [],
        },
        {
          name: "Adoption (Demand)",
          data: [],
        },
      ],
      chartOptions: {
  ...
  methods: {
    ...
    aggregateDimensionsInnovation(
      ...
      var active_developers = this.getDimensionValuesInnovation(
        active_developers,
        "Active Developers",
        state.dimension1Weight,
        state.dimension1Threshold
      );
      var interested_developers = this.getDimensionValuesInnovation(
        interested_developers,
        "Interested Developers",
        state.dimension2Weight,
        state.dimension2Threshold
      );
      var contract_deployers = this.getDimensionValuesInnovation(
        contract_deployers,
        "Contract Deployers",
        state.dimension3Weight,
        state.dimension3Threshold
      );
      var verified_smart_contracts = this.getDimensionValuesInnovation(
        verified_smart_contracts,
        "Verified Smart Contracts",
        state.dimension4Weight,
        state.dimension4Threshold
      );
      var web3_ethers_downloads = this.getDimensionValuesInnovation(
        web3_ethers_downloads,
        "web3+ethers Downloads",
        state.dimension5Weight,
        state.dimension5Threshold
      );
      var academic_publications = this.getDimensionValuesInnovation(
        academic_publications,
        "Academic Publications",
        state.dimension6Weight,
        state.dimension6Threshold
      );
      var job_search_trends = this.getDimensionValuesInnovation(
        job_search_trends,
        "Search Interest",
        state.dimension7Weight,
        state.dimension7Threshold
      );
      var active_addresses = this.getDimensionValuesInnovation(
        active_addresses,
        "Active Addresses",
        state.dimension8Weight,
        state.dimension8Threshold
      );
      var transactions = this.getDimensionValuesInnovation(
        transactions,
        "Transactions",
        state.dimension9Weight,
        state.dimension9Threshold
      );
      var mobile_wallet_maus = this.getDimensionValuesInnovation(
        mobile_wallet_maus,
        "Mobile Wallet Users",
        state.dimension10Weight,
        state.dimension10Threshold
      );
      var dex_volume = this.getDimensionValuesInnovation(
        dex_volume,
        "DEX Volume",
        state.dimension11Weight,
        state.dimension11Threshold
      );
      var nft_volume = this.getDimensionValuesInnovation(
        nft_volume,
        "NFT Volume",
        state.dimension12Weight,
        state.dimension12Threshold
      );
      var stablecoin_volume = this.getDimensionValuesInnovation(
        stablecoin_volume,
        "Stablecoin Volume",
        state.dimension13Weight,
        state.dimension13Threshold
      );
      var transaction_fees_paid = this.getDimensionValuesInnovation(
        transaction_fees_paid,
        "Transaction Fees Paid",
        state.dimension14Weight,
        state.dimension14Threshold
      ...
      for (var record = 0; record < active_developers.length; record++) {
        ...
        this.series[1].data = [...this.series[1].data, posNum.toFixed(2)];
      }

      return soc_index;
    },
    getDimensionValuesAdoption(
      dimension,
      value_name,
      dimension_weight,
      min_threshold
    ...
    aggregateDimensionsAdoption(
      ...
      const state = this.$store.state;
      var active_developers = this.getDimensionValuesAdoption(
        active_developers,
        "Active Developers",
        state.dimension1Weight,
        state.dimension1Threshold
      );
      var interested_developers = this.getDimensionValuesAdoption(
        interested_developers,
        "Interested Developers",
        state.dimension2Weight,
        state.dimension2Threshold
      );
      var contract_deployers = this.getDimensionValuesAdoption(
        contract_deployers,
        "Contract Deployers",
        state.dimension3Weight,
        state.dimension3Threshold
      );
      var verified_smart_contracts = this.getDimensionValuesAdoption(
        verified_smart_contracts,
        "Verified Smart Contracts",
        state.dimension4Weight,
        state.dimension4Threshold
      );
      var web3_ethers_downloads = this.getDimensionValuesAdoption(
        web3_ethers_downloads,
        "web3+ethers Downloads",
        state.dimension5Weight,
        state.dimension5Threshold
      );
      var academic_publications = this.getDimensionValuesAdoption(
        academic_publications,
        "Academic Publications",
        state.dimension6Weight,
        state.dimension6Threshold
      );
      var job_search_trends = this.getDimensionValuesAdoption(
        job_search_trends,
        "Search Interest",
        state.dimension7Weight,
        state.dimension7Threshold
      );
      var active_addresses = this.getDimensionValuesAdoption(
        active_addresses,
        "Active Addresses",
        state.dimension8Weight,
        state.dimension8Threshold
      );
      var transactions = this.getDimensionValuesAdoption(
        transactions,
        "Transactions",
        state.dimension9Weight,
        state.dimension9Threshold
      );
      var mobile_wallet_maus = this.getDimensionValuesAdoption(
        mobile_wallet_maus,
        "Mobile Wallet Users",
        state.dimension10Weight,
        state.dimension10Threshold
      );
      var dex_volume = this.getDimensionValuesAdoption(
        dex_volume,
        "DEX Volume",
        state.dimension11Weight,
        state.dimension11Threshold
      );
      var nft_volume = this.getDimensionValuesAdoption(
        nft_volume,
        "NFT Volume",
        state.dimension12Weight,
        state.dimension12Threshold
      );
      var stablecoin_volume = this.getDimensionValuesAdoption(
        stablecoin_volume,
        "Stablecoin Volume",
        state.dimension13Weight,
        state.dimension13Threshold
      );
      var transaction_fees_paid = this.getDimensionValuesAdoption(
        transaction_fees_paid,
        "Transaction Fees Paid",
        state.dimension14Weight,
        state.dimension14Threshold
      ...
      for (var record = 0; record < active_developers.length; record++) {
        ...
        this.series[2].data = [...this.series[2].data, posNum.toFixed(2)];
      }
  ...
  async mounted() {
    ...
    await this.aggregateDimensionsInnovation(
      active_developers,
      interested_developers,
      contract_deployers,
      verified_smart_contracts,
    ...
    await this.aggregateDimensionsAdoption(
      active_developers,
      interested_developers,
      contract_deployers,
      verified_smart_contracts,
