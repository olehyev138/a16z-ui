...
export default {
  ...
  methods: {
    aggregateDimensions(contract_deployers) {
      contract_deployers.forEach((element) => {
  ...
  async mounted() {
    await this.aggregateDimensions(contract_deployers);
