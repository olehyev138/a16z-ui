...
export default {
  name: "MobileWalletUsers",
  data() {
    return {
      show: false,
      series: [
        {
          name: "Mobile Wallet Users",
          data: [],
        },
      ],
      chartOptions: {
  ...
  methods: {
    aggregateDimensions(mobile_wallet_maus) {
      mobile_wallet_maus.forEach((element) => {
  ...
  async mounted() {
    await this.aggregateDimensions(mobile_wallet_maus);
