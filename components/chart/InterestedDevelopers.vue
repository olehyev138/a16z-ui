...
export default {
  name: "InterestedDevelopers",
  data() {
    return {
      show: false,
      series: [
        {
          name: "Interested Developers",
          data: [],
        },
      ],
      chartOptions: {
  ...
  methods: {
    aggregateDimensions(interested_developers) {
      interested_developers.forEach((element) => {
  ...
  async mounted() {
    await this.aggregateDimensions(interested_developers);
