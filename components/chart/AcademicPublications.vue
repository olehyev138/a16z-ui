...
export default {
  ...
  methods: {
    aggregateDimensions(academic_publications) {
      academic_publications.forEach((element) => {
  ...
  async mounted() {
    await this.aggregateDimensions(academic_publications);
