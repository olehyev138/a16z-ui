...
export default {
  ...
  methods: {
    aggregateDimensions(stablecoin_volume) {
      stablecoin_volume.forEach((element) => {
  ...
  async mounted() {
    await this.aggregateDimensions(stablecoin_volume);
