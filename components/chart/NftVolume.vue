...
export default {
  ...
  methods: {
    aggregateDimensions(nft_volume) {
      nft_volume.forEach((element) => {
        this.chartOptions.labels = [
          ...this.chartOptions.labels,
          element["month"],
        ];
        this.series[0].data = [...this.series[0].data, element["NFT Volume"]];
      });
      return [];
    },
  },
  async mounted() {
    await this.aggregateDimensions(nft_volume);
