...
export default {
  ...
  methods: {
    aggregateDimensions(active_developers) {
      active_developers.forEach((element) => {
  ...
  async mounted() {
    await this.aggregateDimensions(active_developers);
