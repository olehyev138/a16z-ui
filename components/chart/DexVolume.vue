...
export default {
  ...
  methods: {
    aggregateDimensions(dex_volume) {
      dex_volume.forEach((element) => {
        this.chartOptions.labels = [
          ...this.chartOptions.labels,
          element["month"],
        ];
        this.series[0].data = [...this.series[0].data, element["DEX Volume"]];
      });
      return [];
    },
  },
  async mounted() {
    await this.aggregateDimensions(dex_volume);
